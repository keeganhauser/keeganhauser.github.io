...
If you want to remount the same app, move your app creation logic into a factory function and create fresh app instances for each mount - e.g. \`const createkeeganhauser.github.io = () => createApp(App)\``
          );
        }
      },
      unmount() {
