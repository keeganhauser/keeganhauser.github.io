...
export default {
    ...
    <div class="flex flex-col w-96">
      ...
      <h4 class="py-6 text-center text-xl">In <span class="font-semibold text-indigo-700">/keeganhauser.github.io</span>, Run Tailwind</h4>
    ...
    setup(props) {
        ...
        const projectZip = computed(() => (project.value || 'keeganhauser.github.io') + '.zip')

        /** @param {string} template */
        const zipUrl = (template) =>
            `https://account.servicestack.net/archive/${template}?Name=${project.value || 'keeganhauser.github.io'}`
